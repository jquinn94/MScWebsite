<?php
    ...
    //getting trainee info and the coach info
    $traineeemail = $_SESSION['authlogin'];
    $coachinfoquery = "SELECT * FROM PT_users WHERE users_id='$iddata'";
    ...
    if((isset($_POST['submitbtn'])) && (!empty($_POST['messageinput']))){
        ...
        if(!$result2){
            ...
            VALUES ('$iddata', '$traineeid', @last_id);
            ";
...
<body>
    ...
    <div id="backgroundimageaboutus">
        ...
        <div id="firstrowsignup" class="row mt-5">
            ...
            <div class="col-sm-6">
                <form method="POST" action=<?php echo "messagecoach.php?id=$iddata"; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="messageinput" rows="5" placeholder="Message (max 4000 characters)"></textarea>
                    </div>
                    <div class="form-group">
