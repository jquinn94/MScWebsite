...
//checking a user id has been set in the url
...
<body>
    ...
    <div id="backgroundimages2">
        ...
        <?php
            ...
            //getting all the clients info to display below
        ...
        <div id="firstrowtrainee" class="row">
            ...
            <div class="col-sm-10">
                ...
                <p><?php echo "<a href='useredit.php?userid=$iddata' class='btn btn-outline-info' role='button'>Edit details</a>";?></p>
                <p><?php echo "<a href='userinputstats.php?userid=$iddata' class='btn btn-outline-info' role='button'>Stats</a>";?></p>
            </div>
            <div class="col-sm-1"></div>
        </div>
